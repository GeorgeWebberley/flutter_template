                        ...
                        child: Container(
                          decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.only(
                                ...
                                topRight: AppBorderRadius.small.topRight,
                              )),
                          child: Row(
        ...
        appBar: AppBar(
          leading: IconButton(
            icon: Icon(
              ...
              color: widget.recipe.image == null ? Colors.black : Colors.white,
            ),
            onPressed: () {
                        ...
                        children: [
                          ...
                          Positioned(
                            ...
                            child: Container(
                              ...
                              padding:
                                  const EdgeInsets.all(AppPading.extraSmall),
                              child: Row(
                                mainAxisAlignment:
                            ...
                            child: Stack(
                              children: [
                                ...
                                Positioned(
                                  ...
                                  child: IconButton(
                                    onPressed: () {
                                      showNutritionalInfo(widget.recipe);
                                    },
